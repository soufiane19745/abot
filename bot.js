...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['ahelp,'made by ak','Type ahelp'];
    var i = -1;
    var j = 0;
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`Dream Life discord https://discord.gg/Khda7QJ`);
    }, ms);
...
return channel.send("")
	...
	client.on('message', message => {
if (message.content.startsWith(prefix + 'owner')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`**
        ***OWNER***
**
!. 𝓓𝓛 ؁ | 𝕬𝕶 ♡?#1654
